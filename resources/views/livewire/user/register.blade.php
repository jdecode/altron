<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('homepage') }}"><img class="mx-auto h-20 w-auto" src="{{ asset('assets/altron.png') }}" alt="Altron"></a>
        ...
        <div class="  px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            <div>
                ...
                <div class="mt-6 grid grid-cols-2 gap-4">
                    <a href="#" class="flex w-full items-center justify-center gap-3 rounded-md   px-3 py-2 text-sm font-semibold   shadow-sm ring-1 ring-inset ring-gray-300/50 hover:bg-gray-50 focus-visible:ring-transparent">
